          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Клубът на програмистите – Велико Търново (ПКВТ) е посветен на насърчаването на жива и сплотена програмистка общност в нашия красив град. Вярваме, че технологиите и програмистките умения са от съществено значение за личностното развитие и развитието на общността.
              </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Запознайте се с отдадените доброволци, които правят ПКВТ възможен.
            </p>
          </div>
