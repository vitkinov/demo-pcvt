              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Veliko Tarnovo, Bulgaria</p>
                    <p className="text-gray-600">Tech Hub Veliko Tarnovo</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">Meeting Times</h3>
                    <p className="text-gray-600">Every Saturday, 2:00 PM</p>
                    <p className="text-gray-600">Monthly workshops on Sundays</p>
                  </div>
                </div>
              </div>
            </div>
